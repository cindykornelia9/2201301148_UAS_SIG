...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
    ...
    // Icon untuk marker 
    var iconPantai = L.icon({iconUrl: "../file/location-pin.png", iconSize: [44, 44], iconAnchor: [22, 44], tooltipAnchor: [22, -20]});
    ...
    foreach ($data as $row) {
        ...
        echo "var marker = L.marker([" . $row->lat . ", " . $row->lng . "], {icon: iconPantai}).addTo(map).bindPopup('<b>" . $row->nama_pantai . "</b><br><img src=\"../file/" . $row->foto . "\" alt=\"Foto\" style=\"width: 100px; height: auto;\"><br>" . $row->alamat . "');";
    }
    ?>
